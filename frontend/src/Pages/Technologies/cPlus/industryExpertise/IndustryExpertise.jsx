...
const IndustryExpertise = () => {
    const SoftwareDesignData = [{ title: "Manufacturing", points: ["------"] }, { title: "Healthcare", points: ["------"] }, { title: "Retail", points: ["------"] }, { title: "Financial services", points: ["------"] }, { title: "Transportation & logistics", points: ["------"] }, { title: "Professional services", points: ["------"] }, { title: "Telecoms", points: ["------"] }, { title: "Education", points: ["------"] }]
    return (
