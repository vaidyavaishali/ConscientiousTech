...
const VRSoftware = () => {
    ...
    const CollabSenario = [{ title: "Develop VR software from scratch", desc: "Win the market with your original and innovative VR application..", bgColor:"FF6868" },
    {
    ...
    return (
        <div className='w-[100vw] h-[auto] box-border py-[80px] md:py-[30px] md:bg-[black] md:text-[white]'>
            <div className='w-[85%] mx-auto md:w-full md:px-3'>
                <h1 className='text-3xl font-bold md:text-[24px] md:text-[#3970F0]'>Don't Let Your Unique VR Software Lose the Race </h1>
                <p className='w-[95%] text-[14px] mt-2 md:w-[100%] md:text-[16px]'>ScienceSoft is a flexible ASP.NET development company that offers different cooperation models to perfectly meet your .NET project needs.</p>
            </div>
