    ...
    return (
        <div className='w-[100vw] bg-[#000000] text-white pt-[60px] pb-[30px]'>
            <div className='w-[85%] mx-[110px] md:w-[90%] md:mx-[20px]'>
                <h1 className='font-bold text-3xl mb-[20px] md:text-[24px]'>Choose Your Cooperation Model</h1>
            ...
            <div className='w-[85%] md:w-[90%] flex flex-wrap justify-between mx-[110px] md:mx-[20px] md:gap-[20px]'>
                <div className='w-[32.5%] md:w-[100%] h-[220px] bg-[#FF6868] box-border p-[15px]'>
                    <h4 className='text-[18px] font-bold'>Team augmentation</h4>
                ...
                <div className='w-[32%] md:w-[100%] h-[220px] bg-[#1777BC] box-border p-[15px]'>
                    <h4 className='text-[18px] font-bold'>Dedicated .NET team</h4>
                ...
                <div className='w-[32%] md:w-[100%] h-[220px] bg-[#E751FF] box-border p-[15px]'>
                    <h4 className='text-[18px] font-bold'>Full .NET project outsourcing</h4>
